        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-cream/70 mb-4 max-w-md font-serif italic text-lg">
              Own Your City&apos;s Black Cultural Hub
            </p>
            <div className="text-cream/60 text-sm space-y-1 mb-6">
              <p>
                <a href="mailto:love@121212.community" className="hover:text-purple-light transition-colors duration-200">
                  love@121212.community
                </a>
              </p>
              <p>
                <a href="mailto:support@121212.community" className="hover:text-purple-light transition-colors duration-200">
          ...
          <div>
            <h3 className="text-purple-light font-serif text-lg font-semibold mb-4">Platform</h3>
            <ul className="space-y-3">
              {platformLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-cream/70 hover:text-purple-light transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
          ...
          <div>
            <h3 className="text-purple-light font-serif text-lg font-semibold mb-4">Ecosystem</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-purple-light font-serif text-lg font-semibold mb-4">Legal</h3>
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.name}>
                  <Link
